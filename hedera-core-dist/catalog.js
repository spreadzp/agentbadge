...
export const MCP_TOOLS_INDEX = [
    ...
    { name: "record_scan", description: "Trigger on-chain scan recording via KeeperHub workflow", category: "keeperhub" },
    { name: "mint_badge", description: "Mint TrustBadge + AgentPassport NFT for verified site", category: "keeperhub" },
    { name: "workflow_status", description: "Check KeeperHub workflow execution status", category: "keeperhub" },
    { name: "audit_events", description: "Read on-chain audit events from TrustRegistry", category: "keeperhub" },
    { name: "verify_cross_chain_task", description: "Verify a cross-chain task from Ethereum Sepolia on Creditcoin", category: "attestcoin" },
    { name: "list_verified_tasks", description: "List all cross-chain tasks verified on Creditcoin", category: "attestcoin" },
    { name: "get_task_status", description: "Get detailed status of a cross-chain task", category: "attestcoin" },
];
