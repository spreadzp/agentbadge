...
export interface HcsMessageReceipt {
    txId: string;
...
export interface TaskEscrowFailedMessage {
    type: "task_escrow_failed";
    taskId: string;
    reason: string;
    timestamp: number;
}
...
export type TaskMessage = TaskPostedMessage | TaskClaimedMessage | TaskDeliveredMessage | TaskCompletedMessage | TaskVerificationFailedMessage | TaskEscrowCreatedMessage | TaskEscrowFailedMessage | TaskCancelledMessage | TaskRewardIncreasedMessage;
...
export interface CachedMarketTask {
    ...
    capabilities: string[];
    deadline?: number;
    status: "posted" | "claiming" | "claimed" | "delivering" | "delivered" | "completing" | "completed" | "cancelling" | "cancelled";
    claimerDid?: string;
    resultBody?: string;
    resultIpfs?: string;
    paymentTxId?: string;
