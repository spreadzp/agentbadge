  ...
  try {
    ...
    const guide = {
      ...
      endpoints: {
        ...
        llms_txt: "/llms.txt",
        openapi: "/api/specs",
        team_capabilities: "/agent-guide/team/capabilities",
        team_services: "/agent-guide/team/services",
        team_contact: "/agent-guide/team/contact",
      ...
      team_endpoints: [
        "GET /agent-guide/team/capabilities",
        "GET /agent-guide/team/services",
