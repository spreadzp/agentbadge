...
const EMAIL_ICON = `<svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>`;
  ...
  return Layout(
    ...
    <div class="mx-auto max-w-2xl">
      ...
      <p class="mt-2 text-sm text-slate-400">
        Send us a message via Discord, Telegram, or Email. We'll get back to you.
      </p>
      ...
      >
        <div>
          ...
          <div class="mt-2 flex flex-col gap-3 sm:flex-row">
            ...
            <button type="button" data-channel="email"
              class="channel-btn flex items-center justify-center gap-2 rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-slate-300 transition-colors hover:border-emerald-500 hover:text-white">
              ${EMAIL_ICON}
              <span>Email</span>
            </button>
