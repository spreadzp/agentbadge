    ...
    <section id="scan" class="relative overflow-hidden px-4 py-20 md:px-8 md:py-28">
      <div class="mx-auto max-w-4xl text-center">
        ...
        <div class="mt-3 text-xs text-slate-500 font-mono">
          No signup · 72 checks · results in seconds
        </div>
      </div>
    </section>
  `;
      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="mt-10 grid gap-8 md:grid-cols-3">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-slate-400">Audit your API with 72 agent readiness checks. Find gaps, get evidence, fix issues.</p>
  ...
  return html`
    <section id="scanner-preview" class="px-4 py-16 md:px-8">
      <div class="mx-auto max-w-4xl">
        ...
        <p class="mt-3 text-slate-400 text-center">Scan any URL for agent readiness — 72 checks across 15 categories.</p>
