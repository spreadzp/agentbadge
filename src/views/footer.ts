...
export function Footer(): ReturnType<typeof html> {
  return html`<footer class="border-t border-slate-800 bg-slate-900">
    ...
    <div class="flex items-center justify-center gap-4 border-t border-slate-800 px-4 py-4">
      ...
      <a href="https://raw.githubusercontent.com/spreadzp/agentgate/refs/heads/main/AGENT-REFERENCE.md" target="_blank" rel="noopener" class="footer-pop inline-flex min-h-6 min-w-6 items-center justify-center p-1 text-slate-400 hover:text-emerald-400" aria-label="GitHub">
        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
