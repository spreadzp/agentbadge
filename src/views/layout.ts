    ...
    <html lang="en" class="h-full bg-slate-950 text-slate-100">
      ...
      <body class="min-h-full">
        ...
        <header class="border-b border-slate-800 bg-slate-900">
          <nav class="px-4 py-3">
            <div class="relative flex items-center justify-between">
              ...
              <div class="absolute left-0 right-0 top-full z-50 flex flex-col gap-1 overflow-hidden border-b border-slate-800 bg-slate-900 px-4 py-0 text-sm transition-all duration-200 max-h-0 peer-checked:max-h-72 peer-checked:py-3 md:hidden">
        ...
        <footer class="border-t border-slate-800 bg-slate-900">
          <div
            class="flex flex-col items-center justify-between gap-4 px-4 py-6 sm:flex-row"
          >
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-6">
              <div class="flex flex-col text-sm text-slate-400 sm:flex-row sm:gap-4">
                <a href="mailto:hello@agentgate.xyz" class="hover:text-emerald-400"
                  >hello@agentgate.xyz</a
                >
                <a href="/agent-guide" class="hover:text-emerald-400">Agent Guide</a>
                <a href="/market-guide" class="hover:text-emerald-400">Market Guide</a>
                <a href="/medical-guide" class="hover:text-emerald-400">Medical Guide</a>
                <a href="/ui/medical-demo" class="hover:text-emerald-400">Medical Demo</a>
                <a
