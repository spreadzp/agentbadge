...
export const allMissing: (Assertion & { category: string; severity: string })[] = [
  createAssertion("AB-001", "GAP", "discovery", "low"),
  createAssertion("AB-002", "GAP", "discovery", "medium"),
  createAssertion("AB-003", "GAP", "discovery", "high"),
  createAssertion("AB-004", "GAP", "documentation", "high"),
  createAssertion("AB-005", "GAP", "documentation", "medium"),
  createAssertion("AB-006", "GAP", "actionability", "medium"),
  createAssertion("AB-007", "GAP", "actionability", "high"),
  createAssertion("AB-008", "GAP", "actionability", "low"),
  createAssertion("AB-009", "GAP", "machine_readable", "medium"),
  createAssertion("AB-010", "GAP", "machine_readable", "medium"),
  createAssertion("AB-011", "GAP", "verification", "high"),
  createAssertion("AB-012", "GAP", "verification", "medium"),
  createAssertion("AB-013", "GAP", "verification", "low"),
];
