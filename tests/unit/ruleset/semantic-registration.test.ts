...
describe("SLICE-95-8: Ruleset Integration", () => {
  ...
  describe("EPIC-125 rules registered", () => {
    const EPIC_125_RULE_IDS = ["AB-161", "AB-162", "AB-163"]; // grows per slice
    ...
    it("total rule count includes EPIC-125 additions", () => {
      // 130 pre-Phase-B + 15 Phase-B + 3 EPIC-125 = 148
      expect(AGENT_READINESS_RULESET.rules.length).toBe(148);
    });
  });
